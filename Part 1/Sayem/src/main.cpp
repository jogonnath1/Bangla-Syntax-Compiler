// =====================================================
//  বাংলা সিনট্যাক্স কম্পাইলার - Sayem (Parser)
//  পর্ব 1 - মৌলিক
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "  ====================================================\n";
    std::cout << "   দলের সদস্য: Sayem\n";
    std::cout << "   দায়িত্ব  : ধাপ ২ -- সিনট্যাক্স বিশ্লেষক (Parser)\n";
    std::cout << "  ====================================================\n\n";
    ...
    // -- ধাপ ২: পার্সিং
    std::cout << "--------------------------------------------------\n";
    std::cout << "[ধাপ ২] সিনট্যাক্স বিশ্লেষণ (Parsing) *** তোমার অংশ ***\n";
    ...
    std::cout << "==================================================\n";
    std::cout << " কম্পাইলেশন সফল! (Sayem এর অংশ সম্পন্ন)\n";
