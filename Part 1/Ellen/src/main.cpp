// =====================================================
//  বাংলা সিনট্যাক্স কম্পাইলার - Ellen (Semantic Analyzer)
//  পর্ব 1 - মৌলিক
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "\n";
    std::cout << "  ====================================================\n";
    std::cout << "   বাংলা সিনট্যাক্স কম্পাইলার  --  পর্ব ১ (মৌলিক)\n";
    std::cout << "   CSE-4114 | কম্পাইলার ডিজাইন সেশনাল\n";
    std::cout << "  ====================================================\n";
    std::cout << "   দলের সদস্য: Ellen\n";
    std::cout << "   দায়িত্ব  : ধাপ ৩ -- অর্থ বিশ্লেষক (Semantic Analyzer)\n";
    std::cout << "  ====================================================\n\n";
    ...
    // -- ধাপ ৩: অর্থ বিশ্লেষণ
    std::cout << "--------------------------------------------------\n";
    std::cout << "[ধাপ ৩] অর্থ বিশ্লেষণ (Semantic Analysis) *** তোমার অংশ ***\n";
    ...
    std::cout << "==================================================\n";
    std::cout << " কম্পাইলেশন সফল! (Ellen এর অংশ সম্পন্ন)\n";
