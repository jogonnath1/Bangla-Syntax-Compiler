// =============================================================
//  Bangla Syntax Compiler — parser.cpp
...
ASTNodePtr Parser::parseDeclaration() {
    Token dhoroTok = consume(TokenType::DHORO, "'ধরি' আশা করা হয়েছিল");
    ...
    Token nameTok = consume(TokenType::IDENTIFIER,
                            "ধরনের পরে চলকের নাম আশা করা হয়েছিল");
    consume(TokenType::ASSIGN, "= লাগানো হয়নি");

    auto initExpr = parseExpression();
    consume(TokenType::SEMICOLON, "ঘোষণার পরে ; দিতে হবে");
...
ASTNodePtr Parser::parseAssignment() {
    Token nameTok = consume(TokenType::IDENTIFIER, "চলকের নাম আশা করা হয়েছিল");
    consume(TokenType::ASSIGN, "হস্তান্তরে = দেওয়া হয়নি");
    auto val = parseExpression();
    consume(TokenType::SEMICOLON, "হস্তান্তরের পরে ; দিতে হবে");
...
ASTNodePtr Parser::parseIf() {
    Token jodiTok = consume(TokenType::JODI, "'যদি' আশা করা হয়েছিল");
    consume(TokenType::LPAREN, "'যদি' লেখার পরে ( দিতে হবে");
    auto cond = parseExpression();
    consume(TokenType::RPAREN, "শর্তের পরে ) দিতে হবে");
...
ASTNodePtr Parser::parseWhile() {
    Token tok = consume(TokenType::JOTOKHON, "'যতক্ষণ' আশা করা হয়েছিল");
    consume(TokenType::LPAREN, "'যতক্ষণ' লেখার পরে ( দিতে হবে");
    auto cond = parseExpression();
    consume(TokenType::RPAREN, "শর্তের পরে ) দিতে হবে");
...
ASTNodePtr Parser::parsePrint() {
    Token tok = consume(TokenType::DEKHAO, "'দেখাও' আশা করতাম");
...
std::unique_ptr<BlockNode> Parser::parseBlock() {
    ...
    consume(TokenType::SHESH, "'শেষ' দিয়ে ব্লক শেষ করতে হবে");
    return block;
}
